...
//                   onClick={generatePDF}
//                   disabled={loading}
//                   className="w-full py-5 bg-slate-800 hover:bg-slate-700 border border-white/10 text-white rounded-3xl font-black transition-all flex items-center justify-center gap-3 shadow-2xl active:scale-95"
//                 >
//                   <Download className="w-5 h-5 text-blue-500" />
//                   DOWNLOAD FULL CERTIFICATE
//                 </button>
